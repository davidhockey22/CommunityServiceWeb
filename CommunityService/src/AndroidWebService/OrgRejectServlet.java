 ...
 */
@WebServlet(urlPatterns = { "/Android/orgReject" })
public class OrgRejectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public OrgRejectServlet() {
		super();
	}
...
//		int tot = 1;
		...
		for(int i = 0; i < tot; i++) {
			...
			try {
				...
				volId = ((String) request.getParameter("reject" + i));
